...
import br.edu.puccampinas.pi3_es_2024_time_25.databinding.ActivityUmaPessoaAlocacaoBinding
...
class UmaPessoaAlocacaoActivity : AppCompatActivity() {
    private lateinit var binding: ActivityUmaPessoaAlocacaoBinding
    private val firestore = FirebaseFirestore.getInstance()
    private val storage = FirebaseStorage.getInstance()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityUmaPessoaAlocacaoBinding.inflate(layoutInflater)
        ...
        firestore.collection("rents").document(documentId)
            ...
            .addOnSuccessListener { documentSnapshot ->
                if (documentSnapshot.exists()) {
                    ...
                    val imageName = (data?.get("images") as? ArrayList<*>)?.get(0).toString()
